...
namespace Pcx
{
    ...
    class DiskMaterialInspector : ShaderGUI
    {
        ...
        {
            editor.ShaderProperty(FindProperty("_Tint", props), "Tint");
            editor.ShaderProperty(FindProperty("_PointSizeScale", props), "Point Size Internal");
            editor.ShaderProperty(FindProperty("_PointSize", props), "Point Size");
            editor.ShaderProperty(FindProperty("_UseInterpolation", props), "Use Interpolation");
            editor.ShaderProperty(FindProperty("_UseAdaptivePointSize", props), "Use Adaptive Point Size");
        }
    }
}
